...
- 💙 **[whatsapp-public-logan](https://github.com/hoodini/whatsapp-public-logan)** - Open-source WhatsApp bot with AI capabilities - Logan by YUV.AI ⭐ 40
- 📦 **[ai-agents-skills](https://github.com/hoodini/ai-agents-skills)** - 🧠 AI Agent Skills Repository - A curated collection of specialized skills for AI coding agents (Claude Code, GitHub Copilot, Cursor, Windsurf). Created by Yuval Avidani using GitHub Copilot via VS Code Insiders. ⭐ 93
- 💙 **[hoodini](https://github.com/hoodini/hoodini)** - None ⭐ 2
- 💛 **[3d-extracter](https://github.com/hoodini/3d-extracter)** - Chrome extension to extract and download GLB/GLTF 3D model files from websites
- 💙 **[netviz](https://github.com/hoodini/netviz)** - 🌐 NetViz — Real-time network request visualizer with animated topology, timing waterfalls, and live traffic simulation. Built with React 18, TypeScript, Vite, and Canvas animations for a GitHub Copilot training workshop. ⭐ 1


---

<div align="center">
<sub>⚡ Auto-updated by GitHub Actions | Last sync: <code>2026-02-17 00:22:53 UTC</code></sub>
</div>
...
[![GitHub Star](https://img.shields.io/badge/GitHub-Star-yellow?style=for-the-badge&logo=github)](https://stars.github.com/profiles/hoodini/)
[![AWS GenAI Superstar](https://img.shields.io/badge/AWS-GenAI%20Superstar-orange?style=for-the-badge&logo=amazon-aws)](https://aws.amazon.com/)
[![YUV.AI](https://img.shields.io/badge/YUV.AI-Founder-blue?style=for-the-badge)](https://yuv.ai)
...
<tr>
<td width="50%" valign="top">
  <a href="https://blog.yuv.ai/tambo-ai/">
    <img src="https://yuv-ai-images.s3.us-west-2.amazonaws.com/MBWUacHNIfvNkdUPuo7c0A8.jpg" alt="Tambo AI: SDK לריאקט ליצירת UI גנרטיבי עם סוכני AI" style="width:100%; border-radius:8px;">
  </a>
  <h3><a href="https://blog.yuv.ai/tambo-ai/">Tambo AI: SDK לריאקט ליצירת UI גנרטיבי עם סוכני AI</a></h3>
  <p>הריפו Tambo AI מאת tambo-ai הוא SDK פול-סטאק לריאקט שמאפשר לסוכני AI לרנדר קומפוננטות UI אינטראקטיביות במקום תגובות טקסט בלבד. הוא מטפל בסטרימינג, ניה...</p>
  <sub>📅 Feb 17, 2026</sub>
</td>
<td width="50%" valign="top">
  <a href="https://blog.yuv.ai/claude-code-hooks-mastery/">
    <img src="https://yuv-ai-images.s3.us-west-2.amazonaws.com/tn2NacCHKbyXkdUPjuWGwQI.jpg" alt="Claude Code Hooks Mastery: שליטה דטרמיניסטית בסוכני AI ותזמור מתקדם" style="width:100%; border-radius:8px;">
  </a>
  <h3><a href="https://blog.yuv.ai/claude-code-hooks-mastery/">Claude Code Hooks Mastery: שליטה דטרמיניסטית בסוכני AI ותזמור מתקדם</a></h3>
  <p>הריפו Claude Code Hooks Mastery מאת disler הוא ארגז כלים מקיף שמספק 13 הוקים לשליטה בכל שלב של ביצוע Claude Code CLI. הוא מאפשר למפתחים לבנות תהליכי A...</p>
  <sub>📅 Feb 12, 2026</sub>
</td>
</tr>
<tr>
<td width="50%" valign="top">
  <a href="https://blog.yuv.ai/gh-aw/">
    <img src="https://yuv-ai-images.s3.us-west-2.amazonaws.com/_NqKabG6BYKckdUPr_iFmAo.jpg" alt="GitHub Agentic Workflows: כתבו CI/CD בשפה טבעית" style="width:100%; border-radius:8px;">
  </a>
  <h3><a href="https://blog.yuv.ai/gh-aw/">GitHub Agentic Workflows: כתבו CI/CD בשפה טבעית</a></h3>
  <p>הריפו GitHub Agentic Workflows (gh-aw) מאת GitHub הוא פריימוורק שמאפשר למפתחים להגדיר תהליכי CI/CD באמצעות מרקדאון בשפה טבעית במקום YAML. הוא מאפשר לס...</p>
  <sub>📅 Feb 10, 2026</sub>
</td>
<td width="50%" valign="top">
...
<td width="50%" valign="top">
  ...
  <h3><a href="https://blog.yuv.ai/memu/">memU: פריימוורק זיכרון מתמיד לסוכני AI פרואקטיביים 24/7</a></h3>
...
<td width="50%" valign="top">
  ...
  <h3><a href="https://blog.yuv.ai/pi-mono/">Pi Monorepo: ערכת כלים מאוחדת לבניית סוכני AI</a></h3>
